...
using Argon.Api.Attributes.Environment;
...
namespace Argon.Api.Core
{
	public class ConfigManager : IConfigManager
	{
		private static string configEnv = "ARGON_CONFIG_FILE";
		private static string configFileName = "argon-config.yaml";

		private readonly ILogger _logger;
		private readonly IArgonManager _neonManager;
		private readonly ContainerBuilder _containerBuilder;

		private ArgonConfig _config;
		private string _configFullPath;
		private bool _isConfigFound;

		public ArgonConfig Configuration => _config;

		public ConfigManager(ILogger logger, IArgonManager neonManager, ContainerBuilder containerBuilder)
		{
